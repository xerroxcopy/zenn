...
- まずAngelina Jolieのような大きな唇について。大きな唇をもつ個体は大きな唇をもつ相手を選好して交配するのか？を調べたところ、LabでもFieldでもそうだった。
- Plenary Lectureでは触れられていなかったが、動画によると人間用のボトックスで薄唇型のシクリッドの唇を無理やり整形し、phenotypeとgenotypeを
